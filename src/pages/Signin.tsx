    ...
    <div className="min-h-screen flex w-screen">
        ...
        <main className="relative flex flex-col items-center justify-center w-full">
            ...
            <section className="container mx-auto flex flex-col items-center justify-center p-4">
                ...
                <form className="text-violet-950 flex flex-col items-center justify-center space-y-4 bg-white/50 rounded-xl border-2 max-w-xl p-16 border-b-4 border-r-4 border-violet-300 w-full" onSubmit={submitHandler}>
