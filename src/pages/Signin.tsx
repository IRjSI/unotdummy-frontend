...
const Signin = () => {
    ...
    const submitHandler = async (e: React.FormEvent) => {
        ...
        setError("")
        try {
            const res = await axios.post(`${import.meta.env.VITE_BACKEND_URL}/user/signin`, formData)
    ...
    <div className="min-h-screen flex w-screen">
        ...
        <main className="relative flex flex-col items-center justify-center w-full">
            ...
            <section className="container mx-auto flex flex-col items-center justify-center">
                ...
                <form className="text-violet-950 flex flex-col items-center justify-center space-y-4 bg-white/50 rounded-xl border-2 max-w-lg p-16 border-b-4 border-r-4 border-violet-300 w-full" onSubmit={submitHandler}>
                    ...
                    <div className="w-full">
                        <div className="group">
                            <button 
                                className="flex items-center justify-center gap-2 py-4 px-6 w-full font-semibold text-lg bg-gradient-to-r hover:scale-105 transition-all duration-300 border-violet-900 border-b-4 border-r-4 from-violet-600 via-violet-500 to-violet-600 rounded-xl"
                                type="submit"
                            >
                                {loading ? "Wait..." : "Next"}
